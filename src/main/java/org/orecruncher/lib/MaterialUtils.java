...
public final class MaterialUtils {
    ...
    static {
        ...
        materialMap.put(Material.STRUCTURAL_AIR, "STRUCTURE_AIR");
        materialMap.put(Material.PORTAL, "PORTAL");
        materialMap.put(Material.CLOTH_DECORATION, "CLOTH_DECORATION");
        materialMap.put(Material.PLANT, "PLANTS");
        materialMap.put(Material.WATER_PLANT, "WATER_PLANT");
        materialMap.put(Material.REPLACEABLE_PLANT, "REPLACEABLE_PLANT");
        materialMap.put(Material.REPLACEABLE_WATER_PLANT, "REPLACEABLE_WATER_PLANT");
        ...
        materialMap.put(Material.EXPLOSIVE, "EXPLOSIVE");
